...
## CachyOS
- 链接：
  - [ISO on GitHub](https://github.com/CachyOS/CachyOS-Live-ISO)
  - [Site](https://cachyos.org)
- 通过对 `x86-64-v3` 和 `x86-64-v4` 的支持实现了性能优化，但对 CPU 有要求。

## EndeavourOS
- 链接：
  - [ISO on GitHub](https://github.com/endeavouros-team/EndeavourOS-ISO)
  - [Site](https://endeavouros.com)
- 经典的 Arch Linux 衍生发行版。

## Parabola GNU/Linux-libre
- 链接：
  - [Site](https://www.parabola.nu)
  - [ISO Git repo](https://git.parabola.nu/parabolaiso.git)
  - [Wiki about ISO](https://wiki.parabola.nu/Hacking:isos)
...
## ArchLive（停更于 2018）
- 链接：
  - [GitHub](https://github.com/Yeyongmeng29/ArchLive)
  - [SourceForge](https://sourceforge.net/projects/archlive)
- KDE|XFCE4

## 更适合中国宝宝体质的Archlinux安装镜像（非自由开源）
- 链接：
  - [Video](https://www.bilibili.com/video/BV1Qz4y1T7U2)
  - [Article](https://www.bilibili.com/read/cv25993181)
- KDE Plasma
...
- 链接：
  - [GitHub](https://github.com/archlinux-jerry/custom-archiso)
- XFCE4；此外还有不带 GUI 的几个变种，包括 arm 支持。
- （疑似）利用 GitHub Actions 自动构建。

## Archuseriso
- 链接：
  - [GitHub](https://github.com/laurent85v/archuseriso)
- XFCE4；其在定位上是构建 Live CD 或安装持久化 Live 系统到 U 盘的工具，XFCE4 是其中一种配置。

## `Archiso_XFCE4`（停更于 2020）
- 链接：
  - [GitHub](https://github.com/Dogcatfee/Archiso_XFCE4)
- XFCE4
...
- 链接：
  - [GitHub](https://github.com/arch-linux-calamares-installer/alci-iso)
- 简称 ALCI。
- 采用 Linux 图形化安装器 [Calamares](https://github.com/calamares/calamares)。

## Graphical Arch Repair Tool（停更于 2023）
- 链接：
  - [GitHub](https://github.com/matiasvlevi/archiso-gui)
- 简称 G.A.R.T。
- i3wm

## Arch Linux Live/Rescue Image for Microsoft Surface（停更于 2021）
- 链接：
  - [GitHub](https://github.com/SamLukeYes/archiso-surface)
- GNOME
