...
# 家目录就位
rsync -av --delete ./layer-home/public/ ./airootfs/etc/skel/
rsync -av ./layer-home/public/ ./airootfs/root/
rsync -av ./layer-home/skel/ ./airootfs/etc/skel/
rsync -av ./layer-home/root/ ./airootfs/root/
pandoc README.md \
  -N \
